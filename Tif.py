...
class Tif:
  ...
  # @name IMPORT METHODS
  #@{
  def __init__(self, fileName, fileType=None, pixelSize=None):
    """
    ...
    if self.producer == "Void":             # Void data
      print("Set data manually. For instance setData")
      return
    logging.info("Open file: "+fileName)    #all other types
